...
export const StoreProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  // Ensure legacy cached demo data is cleared for visitors
  if (typeof window !== 'undefined' && !localStorage.getItem('zezo_demo_v4_cleared')) {
    localStorage.removeItem('zezo_products');
    localStorage.removeItem('zezo_orders');
    localStorage.removeItem('zezo_cart');
    localStorage.removeItem('zezo_wishlist');
    localStorage.removeItem('zezo_current_user');
    localStorage.setItem('zezo_demo_v4_cleared', 'true');
  }
