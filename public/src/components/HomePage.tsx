...
const COMING_SOON_IMAGE_WOMEN =
  "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 800 1000' width='800' height='1000'%3E%3Cdefs%3E%3ClinearGradient id='bgw' x1='0%25' y1='0%25' x2='100%25' y2='100%25'%3E%3Cstop offset='0%25' stop-color='%231c1917'/%3E%3Cstop offset='50%25' stop-color='%23292524'/%3E%3Cstop offset='100%25' stop-color='%230c0a09'/%3E%3C/linearGradient%3E%3CradialGradient id='gw' cx='50%25' cy='40%25' r='60%25'%3E%3Cstop offset='0%25' stop-color='%23e11d48' stop-opacity='0.22'/%3E%3Cstop offset='100%25' stop-color='%23000000' stop-opacity='0'/%3E%3C/radialGradient%3E%3C/defs%3E%3Crect width='800' height='1000' fill='url(%23bgw)'/%3E%3Ccircle cx='400' cy='400' r='340' fill='url(%23gw)'/%3E%3Crect x='30' y='30' width='740' height='940' rx='20' fill='none' stroke='rgba(255,255,255,0.1)' stroke-width='1.5' stroke-dasharray='8 8'/%3E%3Cg transform='translate(400, 390)' text-anchor='middle'%3E%3Crect x='-120' y='-120' width='240' height='38' rx='19' fill='rgba(255,255,255,0.08)' stroke='rgba(255,255,255,0.18)' stroke-width='1.5'/%3E%3Ctext y='-96' font-family='sans-serif' font-size='12' font-weight='700' letter-spacing='3' fill='%23fda4af' text-transform='uppercase'%3EWOMEN%27S CLOTHING%3C/text%3E%3Ctext y='5' font-family='sans-serif' font-size='54' font-weight='900' letter-spacing='6' fill='%23ffffff'%3ECOMING%3C/text%3E%3Ctext y='70' font-family='sans-serif' font-size='54' font-weight='900' letter-spacing='6' fill='%23f43f5e'%3ESOON%3C/text%3E%3Cline x1='-70' y1='115' x2='70' y2='115' stroke='rgba(255,255,255,0.2)' stroke-width='2' stroke-linecap='round'/%3E%3Ctext y='148' font-family='sans-serif' font-size='14' font-weight='600' letter-spacing='3' fill='%23a8a29e'%3ECOLLECTION ARRIVING SOON%3C/text%3E%3C/g%3E%3C/svg%3E";

const COMING_SOON_IMAGE_KIDS =
  "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 800 1000' width='800' height='1000'%3E%3Cdefs%3E%3ClinearGradient id='bgk' x1='0%25' y1='0%25' x2='100%25' y2='100%25'%3E%3Cstop offset='0%25' stop-color='%230f172a'/%3E%3Cstop offset='50%25' stop-color='%231e293b'/%3E%3Cstop offset='100%25' stop-color='%23020617'/%3E%3C/linearGradient%3E%3CradialGradient id='gk' cx='50%25' cy='40%25' r='60%25'%3E%3Cstop offset='0%25' stop-color='%230284c7' stop-opacity='0.22'/%3E%3Cstop offset='100%25' stop-color='%23000000' stop-opacity='0'/%3E%3C/radialGradient%3E%3C/defs%3E%3Crect width='800' height='1000' fill='url(%23bgk)'/%3E%3Ccircle cx='400' cy='400' r='340' fill='url(%23gk)'/%3E%3Crect x='30' y='30' width='740' height='940' rx='20' fill='none' stroke='rgba(255,255,255,0.1)' stroke-width='1.5' stroke-dasharray='8 8'/%3E%3Cg transform='translate(400, 390)' text-anchor='middle'%3E%3Crect x='-110' y='-120' width='220' height='38' rx='19' fill='rgba(255,255,255,0.08)' stroke='rgba(255,255,255,0.18)' stroke-width='1.5'/%3E%3Ctext y='-96' font-family='sans-serif' font-size='12' font-weight='700' letter-spacing='3' fill='%237dd3fc' text-transform='uppercase'%3EKIDS CLOTHING%3C/text%3E%3Ctext y='5' font-family='sans-serif' font-size='54' font-weight='900' letter-spacing='6' fill='%23ffffff'%3ECOMING%3C/text%3E%3Ctext y='70' font-family='sans-serif' font-size='54' font-weight='900' letter-spacing='6' fill='%2338bdf8'%3ESOON%3C/text%3E%3Cline x1='-70' y1='115' x2='70' y2='115' stroke='rgba(255,255,255,0.2)' stroke-width='2' stroke-linecap='round'/%3E%3Ctext y='148' font-family='sans-serif' font-size='14' font-weight='600' letter-spacing='3' fill='%2394a3b8'%3ECOLLECTION ARRIVING SOON%3C/text%3E%3C/g%3E%3C/svg%3E";
    ...
    <div className="space-y-12 sm:space-y-16 pb-16">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          ...
          >
            <img
              src={COMING_SOON_IMAGE_WOMEN}
              alt="Women's Clothing - Coming Soon"
              className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent" />
            <div className="absolute bottom-5 left-5 right-5 text-white">
              <h3 className="text-xl font-black tracking-tight">Women's Clothing</h3>
              <p className="text-[11px] text-neutral-300 line-clamp-1 mt-0.5">
                Coming Soon
              </p>
              <span className="inline-flex items-center gap-1 text-[11px] font-bold text-white mt-2 group-hover:translate-x-1 transition-transform">
          ...
          >
            <img
              src={COMING_SOON_IMAGE_KIDS}
              alt="Kids Clothing - Coming Soon"
              className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent" />
            <div className="absolute bottom-5 left-5 right-5 text-white">
              <h3 className="text-xl font-black tracking-tight">Kids Clothing</h3>
              <p className="text-[11px] text-neutral-300 line-clamp-1 mt-0.5">
                Coming Soon
              </p>
              <span className="inline-flex items-center gap-1 text-[11px] font-bold text-white mt-2 group-hover:translate-x-1 transition-transform">
