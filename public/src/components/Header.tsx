          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {currentUser ? (
              <button
                id="header-user-btn"
                onClick={() => setCurrentView('account')}
                className="flex items-center gap-2 px-2.5 sm:px-3 py-1.5 bg-neutral-100 hover:bg-neutral-200 text-neutral-900 rounded-full text-xs transition-colors border border-neutral-200 shadow-2xs"
                title={`Logged in as ${currentUser.email}`}
              >
                <div className="w-6 h-6 rounded-full bg-neutral-950 text-white flex items-center justify-center text-[10px] font-bold shrink-0">
                  {(currentUser.fullName || currentUser.email || 'U')[0].toUpperCase()}
                </div>
                <div className="flex flex-col text-left">
                  <span className="hidden sm:inline font-bold text-neutral-950 text-[11px] leading-tight max-w-[140px] truncate">
                    {currentUser.email}
                  </span>
                  <span className="hidden md:inline text-[9px] text-emerald-700 font-semibold leading-tight">
                    Active Account
                  </span>
                </div>
              </button>
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="px-2.5 py-1.5 text-xs font-bold text-neutral-700 hover:text-neutral-950 rounded-lg hover:bg-neutral-100 transition-colors"
                >
                  Login
                </button>
                <button
                  ...
                  className="hidden sm:inline-flex px-3 py-1.5 bg-neutral-950 text-white hover:bg-neutral-800 rounded-full text-xs font-bold transition-colors shadow-2xs"
                >
                  Register
                </button>
              </div>
